class Engine(object):
    ...
    def get_black_move(self, board, move_num=None, 
        ...
        """ Returns the black player's move, given a board. 
        Calls self.get_move(board, -1) by default."""
    ...
    def get_white_move(self, board, move_num=None,
                       time_remaining=None, time_opponent=None):
        """ Returns the white player's move, given a board. 
        Calls self.get_move(board, -1) by default."""
        raise DeprecationWarning
        return self.get_move(board, 1, move_num, 
                             time_remaining, time_opponent)
    ...
    def get_move(self, board, color, move_num=None,
        ...
        method otherwise raises a NotImplementedError. """
